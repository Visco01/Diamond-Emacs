...
(custom-set-variables
 ...
 '(package-selected-packages
   '(helm page-break-line winum vterm-toggle use-package solaire-mode org-modern org-auto-tangle olivetti no-littering magit gcmh eshell-toggle auto-package-update)))
(custom-set-faces
